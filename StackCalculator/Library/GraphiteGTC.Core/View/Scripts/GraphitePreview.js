...
function RenderPreview (view, translationResources, theme, language) {
    ...
    Page.Configure(view, 'Pre');

    // Post Translate Operations
    Events.One(document.body, 'translationsloaded',
        function () {
            // Configure Page (Stage - Post Translations)
            Page.Configure(view, 'Post');
        }
    );

    // Translate page
    Common.TranslatePage(false, translationResources);
...
function RenderPreviewModal (jsonObject, translationResources, theme, language) {
    ...
    // Configure page (Stage - Pre Translations)
    Page.Configure(jsonObject, 'Pre');

    // Post Translate Operations
    Events.One(document.body, 'translationsloaded',
        function () {
            // Configure Page (Stage - Post Translations)
            Page.Configure(jsonObject, 'Post');
        }
    );

...
(function (SelectableButton, window, document, Common, Cache, Events, Velocity, undefined) {
    ...
    SelectableButton.Render = function (selectableButton) {
        ...
        var selectableButtonMarkup = '<a role="button" class="' + className + '" data-namespace="SelectableButton"' + ViewElement.RenderAttributes(selectableButton) + EventElement.AttachEvent(selectableButton.Name, 'click', selectableButton.OnClick, SelectableButton.OnClick);

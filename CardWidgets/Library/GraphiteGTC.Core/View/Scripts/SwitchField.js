...
(function (SwitchField, window, document, Common, Cache, Events, Velocity, undefined) {
    ...
    SwitchField.Render = function (switchField) {
        ...
        switchFieldMarkup += '<label class="gtc-switchbox-label" for="' + switchField.Name + '"><input data-namespace="SwitchField" data-checkboxgroup="' + switchField.Name + '" name="' + switchField.Name + '" tabindex="' + switchField.FocusIndex + '" class="gtc-input-switchbox" id="' + switchField.Name + '"';

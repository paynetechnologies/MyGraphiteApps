...
(function (SignatureField, window, document, Common, Cache, Events, Velocity, undefined) {
    ...
    SignatureField.Render = function (signatureField) {
        ...
        signatureFieldMarkup += '<div class="gtc-input-signaturefield" data-namespace="SignatureField" data-configure="Pre" data-export="' + signatureField.ExportType.toLowerCase() + '" data-signature=\'' + fieldValue + '\'';
    ...
    SignatureField.Configure = function (field, configureStage) {

        Events.Trigger(field, 'configuresignature');

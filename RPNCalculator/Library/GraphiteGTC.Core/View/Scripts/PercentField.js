...
(function (PercentField, window, document, Common, Cache, Events, Velocity, undefined) {
    ...
    PercentField.Render = function (percentField) {
        ...
        percentFieldMarkup += ' data-namespace="PercentField" data-configure="Pre" type="text" />';
    ...
    PercentField.Configure = function (field, configureStage) {
    ...
    PercentField.UpdateLabel = function (field, fieldLabel, promises, context) {

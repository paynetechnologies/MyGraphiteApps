 ...
 * @classdesc Supports the CurrencyDisplayItem View Element<br>
...
(function (CurrencyDisplayItem, window, document, Common, Cache, Events, Velocity, undefined) {
    ...
    /**
     * @function CurrencyDisplayItem.Render
     * @param {object} currencyDisplayItem - The CurrencyDisplayItem View Element in JSON format
     * @param {object} displayDetail - The DisplayDetail (in JSON format) that the CurrencyDisplayItem belongs to
     * @description Generates the HTML markup for the CurrencyDisplayItem View Element 
     * @returns {string} HTML Markup of the CurrencyDisplayItem View Element
     */
    ...
    /**
     * @function CurrencyDisplayItem.UpdateValue
     * @param {object} displayItem - The CurrencyDisplayItem DOM element
     * @param {string} fieldValue - The new Value of the CurrencyDisplayItem
     * @param {object[]} promises - An array of promises that is used to know when all Page Instructions are completed
     * @description Updates the Value of the CurrencyDisplayItem
     */
    ...
    /**
     * @function CurrencyDisplayItem.UpdateColor
     * @param {object} displayItem - The CurrencyDisplayItem DOM element
     * @param {string} colorValue - The new color of the Value in the CurrencyDisplayItem
     * @param {object[]} promises - An array of promises that is used to know when all Page Instructions are completed
     * @description Updates the color of the Value of the CurrencyDisplayItem
     */

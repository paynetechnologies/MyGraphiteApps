// DocumentDisplay
// Based On: DocumentDisplay -> ViewElement
(function (DocumentDisplay, window, document, Common, Cache, Events, Velocity, undefined) {
    ...
    DocumentDisplay.Render = function (documentDisplay) {
        ...
        var documentDisplayMarkup = '<div class="gtc-documentdisplay" data-namespace="DocumentDisplay"' + ViewElement.RenderAttributes(documentDisplay);

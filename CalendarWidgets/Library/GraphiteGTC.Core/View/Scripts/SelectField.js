...
(function (SelectField, window, document, Common, Cache, Events, Velocity, undefined) {
    ...
    SelectField.Render = function (selectField) {
        ...
        selectFieldMarkup += '<select data-namespace="SelectField" class="gtc-input-selectbox" data-iconexists="' + iconExists + '" data-labelexists="' + labelExists + '" data-translatecontent="' + selectField.TranslateContent + '" ' + ValueField.RenderAttributes(selectField) + Field.RenderAttributes(selectField);

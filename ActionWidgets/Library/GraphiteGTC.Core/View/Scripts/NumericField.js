...
(function (NumericField, window, document, Common, Cache, Events, Velocity, undefined) {
    ...
    NumericField.Render = function (numericField) {
        ...
        numericFieldMarkup += ' data-namespace="NumericField" data-configure="Pre" type="text" />';
    ...
    NumericField.Configure = function (field, configureStage) {
    ...
    NumericField.UpdateLabel = function (field, fieldLabel, promises, context) {

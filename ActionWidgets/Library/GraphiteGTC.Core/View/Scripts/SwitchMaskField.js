...
(function (SwitchMaskField, window, document, Common, Cache, Events, Velocity, undefined) {
    ...
    SwitchMaskField.Render = function (switchMaskField) {
        ...
        switchMaskFieldMarkup += '" data-namespace="SwitchMaskField" data-configure="Pre"';
    ...
    SwitchMaskField.Configure = function (field, configureStage) {

        var switchMaskCheckbox = Common.Query('.gtc-input-switchmask', field);
        Events.Trigger(switchMaskCheckbox, 'configureswitchmask');
    ...
    SwitchMaskField.UpdateLabel = function (field, fieldLabel, promises, context) {
